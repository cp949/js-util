 ...
 * @internal
 * */
export const toObjectString = (value: unknown): string => Object.prototype.toString.call(value);
 ...
 * ```
 */
export function createTypeGuard<T, O extends TypeGuardOptions | undefined = undefined>(
 ...
 * ```
 */
export function createTypeAssertion<T, O extends TypeAssertionOptions | undefined = ErrorMessage>(
  guard: TypeGuard<T, any>,
): TypeAssertion<T, O> {
